    ...
    @if ($posts->count())
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <p class="card-text">
                    {{ $posts[0]->excerpt }}
                    <a href="/posts/single-post/{{ $posts[0]->slug }}" class="text-decoration-none">Read
                        more...</a>
                </p>
            </div>
        </div>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                {{ $item->excerpt }}
                                <a href="/posts/single-post/{{ $item->slug }}"
                                    class="text-decoration-none btn btn-success">Read more...</a>
                            </p>
                        </div>
                    </div>
                </div>
